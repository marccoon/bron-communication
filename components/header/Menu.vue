      ...
      >
        <ul class="flex lg:flex-row flex-col text-menu xl:text-xl lg:text-base text-2xl lg:font-normal font-medium">
          <n-link
              ...
              class="lg:hover:text-menu-active xl:ml-12
              lg:ml-7 cursor-pointer transition-all duration-150"
          >
            Company
          </n-link>
          ...
          <n-link
              ...
              to="/expertise"
              active-class="lg:text-menu-active"
              class="lg:hover:text-menu-active xl:ml-12 lg:ml-7 lg:mt-0 mt-5 cursor-pointer transition-all duration-150"
          >
            Expertise
          </n-link>
